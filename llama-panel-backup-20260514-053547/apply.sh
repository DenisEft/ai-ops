...
echo "🔧 Installing llama-panel.service..."
cat > /etc/systemd/system/llama-panel.service << 'SERVICE'
[Unit]
Description=Llama Panel — Web Management for llama.cpp
...
Type=simple
User=den
WorkingDirectory=/home/den/.openclaw/workspace/llama-panel/backend
...
echo "✅ llama-panel.service installed"

echo "🔄 Reloading systemd..."
systemctl daemon-reload

echo "✅ Done! Now run:"
echo "   sudo systemctl restart llama-8080 llama-panel"
echo "   sudo systemctl status llama-8080 llama-panel"
