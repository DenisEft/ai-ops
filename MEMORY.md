...
**Ключи:** `~/.openclaw/workspace/secrets/`

Кворум — 3 модели голосуют параллельно, консенсус выбирает ответ.

**Бесплатные модели (free-tier OpenRouter):**
- `gpt-oss-20b`, `gpt-oss-120b`, `nemotron-3-120b`

**Платные модели (из которых платные):**
- `gpt-4o`, `claude-sonnet-4.6` (RouterAI)
- `llama-3.3-70b` (OpenRouter)

**Глубокий анализ (DeepSeek paid) — только для кодинга.**

**Использование:**
- **Монитор (cron)** — бесплатный кворум решает: будить Лору или нет
- **Лора (я)** — могу использовать кворум в сложных решениях
