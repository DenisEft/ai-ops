# AI Ops v2 — Архитектура и дизайн-документ
...
**Sticky header:**
```
🦙 AI Ops  ● Подключено    обновлено 14:32:15  [↻]
```

**Сервисный статус-бар:**
```
🟢 Llama Server: RUNNING    🟢 ai-ops: active    GPU: NVIDIA RTX 3080
```
...
export async function getDashboard() {
  const results = await Promise.allSettled([
    ...
    getServiceStatus('ai-ops.service'),
    getGpuMetrics(),
    getSystemMetrics(),
  ])
...
| `/api/openclaw/status` | удалить | не относится к ai-ops |
